# -*- coding: cp1250 -*-
# gra w wojnę - ten kto wygrywa rundę, zabiera wszystkie karty z rundy do swojej talii
# gracze otrzymują po 1 karcie, wygrywa ten z najwyższą kartą
# jesli jest remis, to karty z rundy przechodzą do "poczekalni" i zgarnia je gracz, który wygra następną rundę
